...
type INode = Awaited<ReturnType<typeof svg['deserialize']>>
...
export const _parse = svg.deserialize
export const _stringify = svg.serialize
...
export const _svgToBuffer = async ( svgData: SvgProps['input'], opts?: Svg2ImgCoreProps ) => {
	...
	return new Promise<Buffer>( async ( resolve, reject ) => {
		...
		let parsedData = await _parse( svgData )
